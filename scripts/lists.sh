...
export GEOSITE_LISTS="my-direct,my-proxy,my-block,category-ru,ru-services,banks-ru,games,tspu-blocked,win-spy,ads,private,youtube,telegram,discord,github,google-play,openai,apple,microsoft,twitch,twitch-ads,pinterest,torrent,whitelist"
